...
Podemos ver, respecto del peso de los padres, que existe una menor variabilidad en el peso en el año 2019, esto relacionado con que no se observan datos por fuera de la distribución normal observada. Por otro lado, la media para este año es de alrededor de 5kg. La mayor variabilidad se observa en el año 2010, año que corresponde al inicio del PMG y por ende a la población inicial, lo que causa esa variabilidad entre los datos, donde se perciben valores atípicos como individuos con peso de hasta más de 20kg. Aquí resalta que en el año 2016 la media fue superior a la media observada en 2019, sin embargo el peso máximo para el año 2016 no supero los 7kg, pero en 2019 se observa una máxima de 8-8.5kg. Esto es un indicio de que el Programa de Mejora Genética ha permitido incrementar el peso promedio de los padres.
```{r}
